  ...
  return <style dangerouslySetInnerHTML={{__html: `
    ...
    * { font-family: 'Assistant', system-ui, sans-serif !important; }
    ...
    @media print {
      ...
      /* להעלים כל מה שלא קשור לתעודה */
      .no-print, aside, header, nav, button, .screen-certificate { 
        display: none !important; 
      }
      
      /* שבירת חוקי הגלילה של React שמייצרים דפים ריקים */
      html, body, #root, main, .flex, .flex-1, .overflow-y-auto, .overflow-hidden, .cert-view-container {
      ...
      .print-certificate-a4 {
        ...
        height: 296mm !important; /* Slightly under 297mm to prevent blank 2nd page */
        margin: 0 !important;
...
// ==========================================
// UNIFIED CERTIFICATE COMPONENT
// ==========================================
// מרנדר גם את תצוגת המסך הרגילה וגם את תצוגת ההדפסה הייעודית בבת אחת
// CSS מטפל בהסתרת והצגת האלמנטים המתאימים מבלי לשבור את ה-DOM
function DigitalCertificate({ data, onBack, isClientView, t, isRtl, hideIsrael, isPublicVerification = false }) {
  ...
  return (
    <>
      {/* ==================== SCREEN VIEW ==================== */}
      <div className="max-w-3xl mx-auto space-y-4 pb-24 animate-in zoom-in-95 screen-certificate print:hidden" dir="rtl">
